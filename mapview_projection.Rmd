...
Let's see how the offices are distributed around Mexico

```{r}
mun.pol <- st_read("C:/Users/jesus/Box/PROPESCA/BIENPESCA/data/clean data/mun_polygons.shp")
state.sf <- st_read(paste0(dir$shp,"state_sf.shp"))
office.sf <- st_read(paste0(dir$shp, "office_sf.shp"))


# use mapview to see how offices and municipios distributed
mapview(state.sf) +
  mapview(office.sf, col.regions = "yellow") +
  mapview(mun.pol)
